...
// scripts/install-moonbit-toolchain.ts
var path6 = __toESM(require("node:path"));
var process10 = __toESM(require("node:process"));
...
// scripts/install-moonbit-toolchain.ts
var WindowInstallVersionEnvVar = "MOONBIT_INSTALL_VERSION";
var install_moonbit = async (version) => {
  if (import_node_process11.platform === "win32") {
    if (version !== "stable") {
      process10.env[WindowInstallVersionEnvVar] = version;
    }
...
var get_version = () => {
  const input = process10.env["MOONBIT_VERSION"];
  switch (input) {
    case "stable":
      return input;
    case "pre-release":
...
var get_home_path = () => {
  switch (import_node_process11.platform) {
    case "linux":
      return "/home/runner" /* Linux */;
    case "win32":
      return "C:\\Users\\runneradmin" /* Windows */;
    case "darwin":
      return "/Users/runner" /* Darwin */;
    default:
      throw Error("unsupported os");
  }
};
var add_moonbit_binary_path_to_home = () => {
  const home = get_home_path();
  const moonbit_binary = path6.join(home, ".moon", "bin");
  const github_path_file = process10.env["GITHUB_PATH"];
